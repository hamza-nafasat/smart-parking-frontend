  ...
  return (
    <div className="flex flex-col sm:flex-row flex-wrap sm:items-center justify-between gap-4 py-2 border-b border-[#e5e5e5]">
      <div className="flex items-center gap-2">
        <img src="https://placehold.co/45x45" alt="image" className="size-[48px] rounded-full object-cover" />
        <div>
          <h6 className="text-sm md:text-base font-semibold text-[#414141] leading-none">Account title</h6>
