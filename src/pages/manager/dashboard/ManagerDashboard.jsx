...
} from "./components/ParkingColumns";
      ...
      <div className="col-span-12 lg:col-span-3 border border-[#2B2B2B33] rounded-lg shadow-md p-4">
        ...
        <div className="flex justify-center">
          <Button
            text="Details"
            width="w-[100px]"
            bg="bg-[#18BC9C] text-[#18BC9C] border-none"
          />
        </div>
      </div>
      <div className="col-span-12 lg:col-span-3 border border-[#2B2B2B33] rounded-lg shadow-md p-4">
        ...
        <div className="flex justify-center">
          <Button
            text="Details"
            width="w-[100px]"
            bg="bg-[#FAA80E] text-[#F39C11] border-none"
          />
        </div>
      </div>
      <div className="col-span-12 lg:col-span-3 border border-[#2B2B2B33] rounded-lg shadow-md p-4">
        ...
        <div className="flex justify-center">
          <Button
            text="Details"
            width="w-[100px]"
            bg="bg-[#1B7AA6] text-[#1B7AA6] border-none"
          />
        </div>
      </div>
      <div className="col-span-12 lg:col-span-3 border border-[#2B2B2B33] rounded-lg shadow-md p-4">
