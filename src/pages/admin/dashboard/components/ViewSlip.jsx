...
import { useGetSingleBookingSlipForAdminQuery } from '../../../../redux/apis/bookingApis';
...
const ViewSlip = () => {
  ...
  const { data } = useGetSingleBookingSlipForAdminQuery(bookingId);
    ...
    <div className="flex md:flex-row flex-col gap-4 py-4">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 w-full">
        <div>
          ...
          <List list={{ title: 'From', value: slipData?.payment?.user || '0232392449343022' }} />
          <List list={{ title: 'To', value: 'company account' }} />
          <List
            list={{
              title: 'Amount',
              value: `$${slipData?.payment?.amount || '100'} ${slipData?.payment?.currency || 'USD'}`,
            }}
          />
